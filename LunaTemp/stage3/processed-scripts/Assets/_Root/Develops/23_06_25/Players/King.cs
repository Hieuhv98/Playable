...
public class King : PlayerBase
{
    ...
    public void MoveToPos([Bridge.Ref] Vector2 pos, Action actionComplete = null)
    {
        _tweenMove.Kill();
    ...
    public void MoveToPos([Bridge.Ref] Vector2 pos, float time, Action actionComplete = null)
    {
        _tweenMove.Kill();
