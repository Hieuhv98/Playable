namespace Gamee.Hiuk.Pattern 
{
	...
	public class PoolManager : Singleton<PoolManager>
	{
		...
		public GameObject spawnObject(GameObject prefab, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation)
		{
			if (!prefabLookup.ContainsKey(prefab))
			{
				WarmPool(prefab, 1);
		...
		public static GameObject SpawnObject(GameObject prefab, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation)
		{
